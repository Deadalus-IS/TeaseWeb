    ...
    <div className={styles.container}>
      ...
      <main class={styles.main}>
        ...
        <text className={styles.text}>
          ...
          <br />
          register for a Tease account via our website;
          <br />
          <br />
          participate in a Tease survey or other marketing campaign; <br />
          <br />
          indicate that you wish to receive marketing material from Tease;{" "}
          <br />
          <br />
          ...
          the pages of Tease and interact with them. For example, Google Maps
          widget (Google Inc.) on event pages <br />
          <br />
          Analytics: This type of services enable Tease to monitor and analyze
        ...
        <text className={styles.text}>
          ...
          <br />
          When you connect third party plaftorms to your Tease account: For
        ...
        <text className={styles.text}>
          ...
          services, (d) protect Tease Technologies, our customers or the public
          from harm or illegal activities, or (e) respond to an emergency which
          we believe in good faith requires us to disclose information to assist
          in preventing the death or serious bodily injury of any person. <br />
          <br />
          ...
          <br />
          Tease and Related Companies: We share information we have about you
          with other Tease corporate affiliates in order to operate and improve
          products and services and to offer other Tease affiliated services to
          you. This includes companies that own or operate the services listed
          here.
          <br />
          <br />
        ...
        <text className={styles.h2}>
          Tease Event Technology Limited Details
        </text>
        <text className={styles.text}>
          The full name of Tease is Deadalus System & Intelligence <br />
          <br />
