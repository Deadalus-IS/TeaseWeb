    ...
    <div className={styles.container}>
      ...
      <main class={styles.main}>
        ...
        <text className={styles.text}>
          You must be 18 years or older to use Tease. <br />
          <br />
          By using or visiting the Tease platform, you expressly agree to be
          ...
          <br />
          Tease reserves the right to change these Terms at any time, effective
          immediately upon posting on the Tease platform. To ensure you are
          aware of the latest Terms and Conditions of use, please check this
          page of the Tease platform periodically. The latest date of issue will
          be posted at the top of this page.
        </text>

        <text className={styles.h2}>Our Site</text>
        <text className={styles.text}>
          Tease products, features, and offerings are available (a) online
          through Tease.africa, webpages, and subdomains "Site" (b) offline at
          events s (c) through mobile applications, application programming
          interfaces. (a), (b), and (c) are collectively referred to as our
          "Services" or "Tease Properties".
        </text>

        <text className={styles.h2}>Our Role</text>
        <text className={styles.text}>
          We provide a platform that sells tickets and collects payments on
          behalf of Event Organizers. Tease is NOT directly involved with the
          operations of event listed on Tease Properties. This means, among
        ...
        <text className={styles.text}>
          ...
          copy of Tease Properties to buy and sell event tickets. You can’t
          duplicate, download, publish, modify or otherwise distribute the
          material on Tease Properties for any purpose other than to review an
          ...
          authorised by Tease to do so.
        </text>

        <text className={styles.h2}>
          Unauthorised Use Of The Tease Platform
        </text>
        <text className={styles.text}>
          Illegal and/or unauthorised uses of the Tease platform, whether for
          unauthorised ticket sales, unauthorised framing of or linking to the
          Tease platform will be investigated and appropriate legal action will
          be taken. In essence, don’t use our Site to do illegal things or make
          it look like we’re doing illegal things.
        </text>

        <text className={styles.h2}>Pricing and Availability</text>
        <text className={styles.text}>
          Organizers using Tease set the number of tickets available for an
          event, and their pricing. Pricing and availability may change at any
          time and without notice. <br />
          <br />
          Once you've successfully added tickets to Tease’s checkout, the price
          and number of tickets you've selected are reserved within the time
          remaining on the checkout timer. If the time expires, you'll have to
        ...
        <text className={styles.text}>
          Event Organizer’s on Tease may link to other websites and social media
          pages that are not under our control. We are not responsible for any
          other website's content, nor by linked to it are we implying any sort
          of endorsement of that website or its operators.
        </text>

        <text className={styles.h2}>Payments</text>
        <text className={styles.text}>
          Tease processes your credit card depending upon the methods accepted
          ...
          card number get collected by Tease, or stored in Tease’s system or
        ...
        <text className={styles.text}>
          When purchasing tickets on Tease, you are limited to the maximum
          number of tickets set by the Event Organizer. If you try to circumvent
          the Tease platforms to purchase more than maximum specified tickets
          per attendee, the event Organizer may tell Tease to cancel additional
          bookings.
        </text>

        <text className={styles.h2}>Order Confirmation</text>
        <text className={styles.text}>
          After you purchase tickets on Tease Properties, you'll be emailed an
          order confirmation. <br />
          <br />
          If you do not receive a confirmation for your tickets, please contact
          us at Tease Support to check the status of your order. Let us know as
          many details as you can about the transaction, including your full
        ...
        <text className={styles.text}>
          ...
          they can print duplicates. Tease tickets use QR code to validate
        ...
        <text className={styles.text}>
          ...
          not in our control. By using Tease Properties, you agree to abide by
          ...
          supplied on theOrganizer’s Tease listing. <br />
          <br />
        ...
        <text className={styles.text}>
          ...
          <br />
          If you are eligible for a refund through Tease, we'll pay what you are
          due. We'll also notify you by email. <br />
          <br />
          Please note that Tease transaction charges are NON REFUNDABLE.
        ...
        <text className={styles.text}>
          Tease or its representatives will never request for your password,
        ...
        <text className={styles.text}>
          ...
          directly on Tease Properties. Some event Organizers may limit transfer
          of tickets between individuals. If you choose to buy a ticket from the
          original purchaser, please use caution and make sure the ticket you
          are purchasing is valid and will be accepted by the event Organizer.
        </text>
        ...
        <text className={styles.text}>
          You may only sell event tickets on Tease Properties where you have the
          rights to do so. In particular, you may not use Tease to unlawfully
          transmit copyrighted material without a license, express consent,
          valid defence or fair use exemption to do so. You must also ensure
          that the content you upload does not infringe the copyrights or other
          rights of third parties (such as privacy or publicity rights) <br />
          <br />
          If you believe that anything displayed on Tease Properties is in
          violation of your intellectual property rights, please notify us at
          <Link href="mailto:support@tease.africa">
            <span className={styles.a}>Tease Help</span>
          </Link>{" "}
        ...
        <text className={styles.text}>
          ...
          <br />
          <br />
          If you decide you no longer want to have a Tease account, or if you no
          longer agree to our terms of service, you can cancel your account at
          any time. To cancel, contact{" "}
          <Link href="mailto:support@tease.africa">
            <span className={styles.a}>Tease Help</span>
          </Link>
          .
        ...
        <text className={styles.text}>
          Tease does not promise that the Tease Properties will be error-free,
          uninterrupted, nor that it will provide specific results from use of
          the Tease or any content, search or link on it. Tease and its content
          are delivered on an “as-is” and “as-available” basis. Tease can not
          ensure that files you download from the Tease platform will be free of
          viruses or contamination or destructive features however, we use the
          best security measures consistent with industry practices to safeguard
          our systems, and to ensure the security of your data. We therefore
          assume no liability for any problems that arise from the interception
          and misuse of information on our Services.
        </text>
        ...
        <text className={styles.text}>
          ...
          Tease AND/OR ITS AFFILIATES MAY MAKE IMPROVEMENTS AND/OR CHANGES TO
          THE SITE AT ANY TIME.
          <br />
          <br />
          Tease AND/OR OUR AFFILIATES MAKE NO REPRESENTATIONS ABOUT THE
          ...
          CONDITION OF ANY KIND. Tease AND/OR OUR AFFILIATES HEREBY DISCLAIM ALL
          ...
          Tease AND/OR OUR AFFILIATES BE LIABLE FOR ANY DIRECT, INDIRECT,
          ...
          NEGLIGENCE, STRICT LIABILITY, OR OTHERWISE, EVEN IF Tease OR ANY OF
